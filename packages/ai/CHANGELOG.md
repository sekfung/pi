...
- Versioned the generated provider model snapshot and made normal builds consume it without contacting external catalog APIs. Model refreshes are now explicit through `npm run generate:models`.
