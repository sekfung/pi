...
- Added an experimental presentation-neutral application interface, framed-CBOR desktop sidecar, shared workflow adapters, extension Host Interactions, and the `pi gui` launcher.
